...
+-----------------------------------+----------------------------------------------------------------------------------------------+
| **Total failures before aborting**| Montako epäonnistunutta tiilenluontikertoja kunnes lopetetaan koko prosessi                  |
+-----------------------------------+----------------------------------------------------------------------------------------------+

\

::: hint-box
Psst! Jos tiedä mitä voit laittaa kohtaan "Number of tasks to use" niin 2\*tietokoneen_suorittimien_lukumäärä on hyvä lähtökohta kokeilulle.
:::
...
Karttatiiliruudukon määritelmä ja tason sijainnin rajauksen mukaan mittakaavoille 0–15 tarvitaan 1 090 karttatiiltä. Kuvien piirtäminen kestää etäpalvelimella näillä asetuksilla minuutin verran.\
...
Tarkista, että nyt **Disk Used** -sarakkeessa näkyy tarvittavat tiedot. Ilmakuvien karttatiilet vievät tällä hetkellä alle yli 700 megatavua. Muut tasot eivät käytä yhtään levytilaa. ![](img/harjoitus_9/image17.png)
...
Edellisessä kohdassa laskettiin muutama karttatiilitasoja. Esimerkiksi Helsingin ilmakuvien mittakaavatason 16 karttatiilet vievät levytilaa yli 200 megatavua.
...
-   Valitse sama **Grid Set** asetus, kun aikaisemmin, eli EPSG:4326.
