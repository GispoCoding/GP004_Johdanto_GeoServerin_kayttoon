...
Avaa **Tile Cache → Tile Layers → taustakartta → Tile Cache**. Ryhmätasoillekin voidaan määritellä karttaruudukkoja.
...
Näkymästä **Tile Cache → Tile Layers**, esikatsele nyt **ortokartta** uudella karttatiiliruudukolla (valitse esimerkiksi **HKI_GK25FIN/jpeg**). Huomaa, että mittakaavatasoja on vain kymmenen ja ne vastaavat karttatiiliruudukon asetuksissa määriteltyjä mittakaavoja. ![](img/harjoitus_9/image31.png)
